...
import com.chenmeng.project.mapper.PostFavourMapper;
import com.chenmeng.project.mapper.PostMapper;
import com.chenmeng.project.mapper.PostThumbMapper;
...
import com.chenmeng.project.model.entity.PostFavour;
import com.chenmeng.project.model.entity.PostThumb;
...
import com.chenmeng.project.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        highlightBuilder.field("title").preTags("<span style='background-color: yellow'>").postTags("</span>");
        highlightBuilder.field("content").preTags("<span style='background-color: yellow'>").postTags("</span>");
